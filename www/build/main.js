...
var HomePage = (function () {
    function HomePage(platform, navCtrl) {
        ...
        this.screenWidth = 0; //width of device app is running upon
        this.progressBarWidth = 0; //current loaded width of progress bar
        platform.ready().then(function (readySource) {
            _this.screenWidth = platform.width(); //initialize screenwidth with device's width
        });
    ...
    HomePage.prototype.progressBar = function () {
        ...
        var fname = function () {
            if (_this.progressBarWidth < (_this.screenWidth * 0.75)) {
                _this.progressBarWidth += 1; // increase width of progress bar by 1px
            }
            else {
                clearInterval(intervalId); //clear interval after loading of progress bar
                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_2__profile_profile__["a" /* ProfilePage */]); //changes from home page to profile page after progress bar has been loaded
            }
        };
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/sharangmalhotra/Desktop/Talent_marketplace-master/src/pages/home/home.html"*/'<ion-content class="myclass">\n\n        <!-- Talent marketplace responsive image -->\n        <img src="../../assets/imgs/talent_market.png" class="heading_image_home">\n        \n        <!-- Progress bar -->\n        <div class="progressBar" [style.width.px]="progressBarWidth"> </div>\n        \n        <!-- white background of progress bar -->\n        <div class="progressBarBackgound"> </div>\n\n</ion-content>'/*ion-inline-end:"/Users/sharangmalhotra/Desktop/Talent_marketplace-master/src/pages/home/home.html"*/
        }),
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, menuCtrl) {
        ...
        this.showJobs = false; //toggle variable for showing/hiding sub menu in side menu
